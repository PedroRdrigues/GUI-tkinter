...
class Relatorios():
  def printClient(self):
    ...
    webbrowser.open(f"D:/17phr/Documents/PROGRAMACAO!/GitHub/GUI_tkinter/Relatorios_clientes/cliente_{'_'.join(self.rel_nome.title().split())}.pdf")
